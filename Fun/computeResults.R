computeResults <- function(buildMethod=c("reg","lassoSS","lassoSSCl"),
  ...
  for(Rv in Rsmlx){
    ...
    save(computationStats,errorStats,resultCovariate,orderList,CovariateModelSelection,resultCovariatePar,resultModel,file=paste0("Save/BuildResults_",Rv,".RData"))
  }
}
