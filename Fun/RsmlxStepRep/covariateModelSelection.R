covariateModelSelection <- function(buildMethod,
  ...
  if(buildMethod=="reg"){
    ...
    covariateModelSelection.lasso(nfolds,alpha,parallel,ncores,stabilitySelection,nSS,thresholdsSS,covFix,pen.coef,weight,paramToUse,eta,p.max,sp0,covariate.model,critMV)
  }
}
