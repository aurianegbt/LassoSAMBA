...
for(r in 1:20){
  ...
  colnames(covariates) <-  paste0("Gen",1:200)
  # colnames(covariates_corr) <-
  ...
  write.csv(sim,file=paste0("Files/FilesPK2/200cov/simulation/simulation_",r,".txt"),quote = F,row.names = F)
...
save(headerTypes,file="Files/FilesPK2/200cov/headerTypes.RData")
