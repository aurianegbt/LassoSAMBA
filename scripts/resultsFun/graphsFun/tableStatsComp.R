tableStatsComp <- function(Folder,subtitle,project,buildMethod,JPEG,PNG){
  ...
  methname=c(reg="stepAIC whith stat. test",lasso="Lasso whithout s.s.",elastinet="Elastic net whithout s.s.",lassoSS="Lasso whith stat. test",elasticnetSS="Elastic Net whith stat. test",rlasso="Lasso with s.s. on replicates",relasticnet="Elastic Net with s.s. on replicates",lassoCrit = "Lasso with multiple thresholds and no s.s.",elasticnetCrit="Elastic Net with multiple thresholds and no s.s.",lassoSSCrit="Lasso with multiple thresholds",elasticnetSSCrit="Elastic Net with multiple thresholds",rlassoCrit="Lasso with mult. thresholds and s.s. on rep.",relasticnetCrit="Elastic Net with mult. thresholds and s.s. on rep.",setNames(paste0("penalized stepAIC pen=",stringr::str_remove_all(buildMethod[stringr::str_detect(buildMethod,"regPEN")],"regPEN")),buildMethod[stringr::str_detect(buildMethod,"regPEN")]),regnoCov0="stepAIC",lassoSSnoCov0="Lasso",elasticnetSSnoCov0="Elastic Net")
