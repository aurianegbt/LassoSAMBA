...
aux = (dataTransCoding %>% filter(visit=="D63"))[,c(6,9:18661)] 
genesKept = names(sort(apply(aux[,-1],2,sd),decreasing = TRUE))[2:201] # keep only 200
...
save(genCorMat,file="data/simulationSetup/corrMatrixPKcorr.RData")
